...
export function ShareButtons({
  message = "I just checked my voter registration status! 🗳️ Make your voice heard at ElectionGuide India",
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-semibold text-[var(--color-primary)]">Spread the Word</span>
      </div>
